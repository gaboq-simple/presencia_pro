...
- **PR-Neg-3 · Negocio: barberos por recompra (sin ranking)** ⚪ todo
  Recompra de héroe real (clientes con ≥2 citas con ESE barbero) vs línea de promedio del local; piso de datos; caveat de justicia. `appointments.staff_id` es NOT NULL (liga fiable). Aggregator nuevo.
