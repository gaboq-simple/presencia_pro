...
**🟡 DEUDA DE VERIFICACIÓN (no bloqueante):** los pasos 1-3 del checkpoint del lado **barbero** (staff_id forzado al intentar crear para otro; tope de 20 alcanzado; teléfono obligatorio con flag TRUE) NO se corrieron en vivo — solo confirmados por lógica (guardados por `role==='barber'` / `require_customer_phone`). Verificar con el PIN de Carlos **al cablear la vista barbero**.
