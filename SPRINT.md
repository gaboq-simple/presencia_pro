...
- **PR-B · Clientela: retención por cohortes** ⚪ todo
  "Nuevos que vuelven %" vs "Recompra de base %" (cohortes separadas, computable desde la serie de visitas completadas, SIN schema nuevo). Falta cerrar ventana (propuesto: 1ª visita en [hoy−90d, hoy−30d] con retorno ≤30d; recompra de base = ≥3 visitas con visita en últimos 60d) + piso de datos (cohorte <5 → banda "sin datos", no % falso). Degradar con gracia en negocio nuevo.
