...
**Fases siguientes (pendientes):** **2b** gate "solo mis citas" en las otras 5 actions del panel (cancel/complete/noShow/reschedule/notes); **2c-ii** RPCs con `set_config` transaction-local para atribución nominativa de bot/cron (`actor_type` bot/system) — hoy esas mutaciones caen en `'unknown'`; **capa VISIBLE** del audit (drawer por cita + panel del dueño), con el rediseño de vistas.
