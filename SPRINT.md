...
#### S6-SEC-01 — Sistema de control de citas (audit trail + permisos por rol) 🔵 in-progress (Fase 1 + 2a 🟢 done; 2b/2c/2d pendientes)
...
**Fases siguientes (pendientes):** **2b** gate "solo mis citas" en las otras 5 actions del panel (cancel/complete/noShow/reschedule/notes); **2c** anti-inflado fino; **2d** audit trail visible (tabla `appointment_audit` + trigger híbrido con `set_config('app.actor_staff_id')`).
