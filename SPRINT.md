...
- **PR-Neg-2 · Negocio: ocupación + heatmap + huecos + palanca** ⚪ todo
  Grilla día×hora sobre CAPACIDAD (aggregator nuevo desde `staff_availability`). Heatmap positivo (más lleno = más verde), ámbar solo top-1-2 vacías. Potencial "$X estimado, no garantizado". Es la pieza de modelado 🔴 (capacidad por franja).
